...
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(2,'DESCRICAO 2',1,'MENSAGEM_ALERTA 2','2020-11-01',2);
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(3,'DESCRICAO 3',2,'MENSAGEM_ALERTA 3','2020-11-01',3);
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(4,'DESCRICAO 4',0,'MENSAGEM_ALERTA 4','2020-11-01',4);
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(5,'DESCRICAO 5',1,'MENSAGEM_ALERTA 5','2020-11-01',5);

insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(6,'DESCRICAO 6',0,'MENSAGEM_ALERTA 6','2020-11-01',1);
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(7,'DESCRICAO 7',1,'MENSAGEM_ALERTA 7','2020-11-01',2);
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(8,'DESCRICAO 8',2,'MENSAGEM_ALERTA 8','2020-11-01',3);
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(9,'DESCRICAO 10',0,'MENSAGEM_ALERTA 10','2020-11-01',4);
insert into plano_acao(CODIGO_PLANO_ACAO, DESCRICAO, GRAU_RISCO, MENSAGEM_ALERTA, DATA_INCLUSAO,CODIGO_BARRAGEM) values(10,'DESCRICAO 10',1,'MENSAGEM_ALERTA 10','2020-11-01',5);
